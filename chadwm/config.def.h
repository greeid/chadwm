...
static const char *const autostart[] = {
    "sh", "~/.config/chadwm/chadwm/autostart.sh", NULL,
    /* Add more autostart commands here, if necessary */
...
static const char *fonts[] = {
    "CaskaydiaCove NF:style:regular:size=12",
...
#define TAGKEYS(KEY, TAG)                                                      \
  {MODKEY, KEY, view, {.ui = 1 << TAG}},                                       \
      {MODKEY | ControlMask, KEY, toggleview, {.ui = 3 << TAG}},               \
